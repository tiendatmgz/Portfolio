            ...
            <figure className='relative'>
                ...
                <figcaption className='absolute top-0  w-full h-full flex items-center justify-center flex-col gap-5 p-8'>
                    ...
                    <div className='w-full flex items-center justify-evenly my-6 text-yellow-500'>
                        <a href={webLink} className='tranform-icon w-14 flex flex-col items-center' target="_blank" rel="noopener noreferrer">
                            <i class="fa-solid fa-arrow-up-right-from-square text-4xl"></i>
                            <span className='hiden-text invisible text-xs'>Website</span>
                        </a>
                        <a href={sourceLink} className='tranform-icon w-14 flex flex-col  items-center' target="_blank" rel="noopener noreferrer">
...
const Project = () => {
    return (
        <section id='project' className='bg-gradient-to-l from-black to-sky-900 border-y-4 border-cyan-700 py-36'>
            <h1 className='text-4xl font-semibold flex items-center justify-center gap-4  text-cyan-500 mx-3 mb-7'>These are some of my personal projects 🤠</h1>
